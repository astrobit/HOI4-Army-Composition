...
function determineArmyStats(who) {
    ...
    for (j = 0; j < 5; j++) {
        ...
        if (elem != null)
            elem.value = armies[sideidx][j].organization.toPrecision(3);
        elem = document.getElementById(side + ":HP " + (j + 1));
        if (elem != null)
            elem.value = armies[sideidx][j].HP.toPrecision(3);
        elem = document.getElementById(side + ":Soft Attack " + (j + 1));
        if (elem != null)
            elem.value = armies[sideidx][j].soft_attack.toPrecision(3);
        elem = document.getElementById(side + ":Hard Attack " + (j + 1));
        if (elem != null)
            elem.value = armies[sideidx][j].hard_attack.toPrecision(3);
        elem = document.getElementById(side + ":Piercing " + (j + 1));
        if (elem != null)
            elem.value = armies[sideidx][j].piercing.toPrecision(3);
        elem = document.getElementById(side + ":Armor " + (j + 1));
        if (elem != null)
            elem.value = armies[sideidx][j].armor.toPrecision(3);
        elem = document.getElementById(side + ":Defense " + (j + 1));
        if (elem != null)
            elem.value = armies[sideidx][j].defense.toPrecision(3);
        elem = document.getElementById(side + ":Breakthrough " + (j + 1));
        if (elem != null)
            elem.value = armies[sideidx][j].breakthrough.toPrecision(3);
        elem = document.getElementById(side + ":Hardness " + (j + 1));
        if (elem != null)
            elem.value = armies[sideidx][j].hardness.toPrecision(3);
